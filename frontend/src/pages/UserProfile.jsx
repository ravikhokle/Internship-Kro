  ...
  return (
    <div className="px-5 md:px-16 lg:px-32 py-10 flex flex-col gap-8 bg-gray-50 min-h-screen">
      <div className="p-5 md:p-8">
        <h1 className="text-2xl md:text-3xl font-semibold pb-3 mb-5">
          User Profile
        </h1>
        ...
        <div className="mt-5 flex flex-col gap-3">
          ...
          <p>
            Email: <span className="text-gray-600">{profile.email}</span>
          </p>
          <p>
            Bio: <span className="text-gray-600">{profile.bio}</span>
          </p>
          <p>
            City: <span className="text-gray-600">{profile.city}</span>
          </p>
          <p>
            Number: <span className="text-gray-600">{profile.number}</span>
          </p>
      ...
      <div className="p-5 md:p-8">
        <h2 className="text-xl md:text-2xl font-semibold pb-3 mb-5">
