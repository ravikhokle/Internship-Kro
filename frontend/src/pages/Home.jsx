        ...
        <div className="px-6 md:px-16 lg:px-32 flex flex-col lg:flex-row h-full sm:gap-10">
          <div className="w-full lg:w-[50%] mb-6 lg:mb-0 flex flex-col justify-center">
            ...
            <div className="mt-10 mr-0 md:mr-10 py-5 px-5 flex items-center bg-white rounded-md shadow-sm">
              <img className="h-5 px-3" src={serachIcon} alt="Search Icon" />
              <input
        ...
        <div className="posts flex flex-wrap justify-center sm:gap-5 lg:gap-16">
          {Posts.length > 0 ? (
            Posts.map((post, index) => (
              <div
                key={index}
                className="post w-full sm:w-[90%] md:w-[45%] px-5 py-5 my-5 sm:my-0 rounded-lg shadow-lg  border-2 border-purple-300 bg-gradient-to-r from-[#c599e52d] from-7% via-[#ca84fc38] via-51% to-[#e2ccf23c] to-98%"
              >
